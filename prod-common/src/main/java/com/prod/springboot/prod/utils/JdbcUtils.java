...
public class JdbcUtils {
    ...
    public static JdbcUtils.JdbcResult getSelect(String tableName, Class<?> entityClass, Map<String, String> entityToDbMap, Map<String, Object> criteria, Map<String, Object> notEqualCriteria) {
        ...
        JdbcUtils.JdbcResult jdbcResult = getWhereClause(tableName, criteria, notEqualCriteria);
        return jdbcResult != null ? new JdbcUtils.JdbcResult(sql.append(jdbcResult.getSql()).toString(), jdbcResult.getParams()) : new JdbcUtils.JdbcResult(sql.toString(), (Object[])null);
    }

    public static JdbcUtils.JdbcResult getSelectForCount(String tableName, Map<String, Object> criteria, Map<String, Object> notEqualCriteria) {
        StringBuilder sql = (new StringBuilder("SELECT count(*) FROM ")).append(tableName);
        JdbcUtils.JdbcResult jdbcResult = getWhereClause(tableName, criteria, notEqualCriteria);
        return jdbcResult != null ? new JdbcUtils.JdbcResult(sql.append(jdbcResult.getSql()).toString(), jdbcResult.getParams()) : new JdbcUtils.JdbcResult(sql.toString(), (Object[])null);
    }

    public static JdbcUtils.JdbcResult getSelectForSum(String tableName, String dbColumToBeSummed, Map<String, Object> criteria, Map<String, Object> notEqualCriteria) {
        StringBuilder sql = (new StringBuilder("SELECT sum(")).append(dbColumToBeSummed).append(") FROM ").append(tableName);
        JdbcUtils.JdbcResult jdbcResult = getWhereClause(tableName, criteria, notEqualCriteria);
        return jdbcResult != null ? new JdbcUtils.JdbcResult(sql.append(jdbcResult.getSql()).toString(), jdbcResult.getParams()) : new JdbcUtils.JdbcResult(sql.toString(), (Object[])null);
    }

    public static JdbcUtils.JdbcResult getInsert(String tableName, Object entity, Map<String, String> entityToDbMap) {
        ...
        if (dbMap != null && dbMap.size() > 0) {
            ...
            sql.append(")");
            return new JdbcUtils.JdbcResult(sql.toString(), params);
        } else {
            return null;
        }
    }
    ...
    public static JdbcUtils.JdbcResult getUpdate(String tableName, Object entity, Map<String, String> entityToDbMap, Map<String, Object> criteria, Map<String, Object> notEqualCriteria) {
        StringBuilder sql = new StringBuilder();
        Map<String, Object> dbMap = transferEntityToDbMap(entity, entityToDbMap);
        if (dbMap != null && dbMap.size() > 0) {
    ...
    private static JdbcUtils.JdbcResult getWhereClause(String tableName, Map<String, Object> criteria, Map<String, Object> notEqualCriteria) {
        StringBuilder sql = new StringBuilder();
        ...
        if (cirteriaSize + notEqualCriteriaSize <= 0) {
            ...
            sql.append(")");
            return new JdbcUtils.JdbcResult(sql.toString(), params.toArray());
        }
    }
    ...
    public static JdbcUtils.JdbcResult getTimeSpanJdbcResult(Date from, Date to, String column) {
        StringBuilder sql = new StringBuilder();
        List<Object> params = new ArrayList();
    ...
    public static JdbcUtils.JdbcResult getPagingJdbcResult(Date from, Date to, String column, Integer page, Integer limit) {
        JdbcUtils.JdbcResult jdbcResult = getTimeSpanJdbcResult(from, to, column);
        ...
        if (limit != null) {
            ...
            sql = sql + " LIMIT " + (page.intValue() - 1) * limit.intValue() + ", " + limit;
        }

        return new JdbcUtils.JdbcResult(sql, jdbcResult.getParams());
    }
